...
class PredictRequest(BaseModel):
    ...
    slow: bool = False  # force a retained trace for Jaeger screenshots
    ...
    try:
        with tracer.start_as_current_span("predict") as span:
            ...
            with tracer.start_as_current_span("vector-search") as s:
                ...
                s.set_attribute("db.operation.name", "search")
                s.set_attribute("db.query.limit", 5)
                time.sleep(0.010)
            ...
            with tracer.start_as_current_span("generate-tokens") as s:
                ...
                if req.slow:
                    time.sleep(2.1)
                    s.set_attribute("lab.slow_trace", True)
